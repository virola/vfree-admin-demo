  ...
  <div class="ele-body ele-body-card">
    ...
    <a-row :gutter="16">
      ...
      <a-col :lg="6" :md="12" :sm="24" :xs="24">
        <a-card class="analysis-chart-card" :bordered="false">
          <div class="ele-text-secondary ele-cell">
            <div class="ele-cell-content">店铺入驻情况</div>
  ...
  methods: {
    ...
    getSaleroomData() {
      ...
      this.saleroomRankData = [
        {name: '上海路 1 号店', value: '323,234'},
        {name: '上海路 2 号店', value: '323,234'},
        {name: '上海路 3 号店', value: '323,234'},
        {name: '上海路 4 号店', value: '323,234'},
        {name: '上海路 5 号店', value: '323,234'},
        {name: '上海路 6 号店', value: '323,234'},
        {name: '上海路 7 号店', value: '323,234'}
      ];
      // 访问量
      this.visitsData = [
        {month: '1月', value: 1098},
