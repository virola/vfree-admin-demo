      ...
      <div class="ele-cell workplace-user-card">
        <div class="ele-cell-content ele-cell">
          ...
          <div class="ele-cell-content">
            <h4 class="ele-elip">早安，{{ loginUser.realname }}，开始您一天的工作吧！</h4>
            <div class="ele-elip ele-text-secondary">
              <cloud-outlined/>
              <em>今日阴转小雨，18℃ - 22℃，出门记得带雨伞哦~</em>
            </div>
          </div>
        </div>
        ...
        <a-card
          ...
          <router-link
            ...
            <shopping-cart-outlined
              class="app-link-icon"
              style="color: #95de64;"/>
            <div class="app-link-title">数据分析</div>
          </router-link>
        </a-card>
      </a-col>
      <a-col :lg="3" :md="6" :sm="12" :xs="12">
        ...
        <a-card
          ...
          <router-link
            ...
            <file-search-outlined
              class="app-link-icon"
              style="color: #b37feb;"/>
            <div class="app-link-title">部门管理</div>
          </router-link>
        </a-card>
      </a-col>
      <a-col :lg="3" :md="6" :sm="12" :xs="12">
        ...
        <a-card
          ...
          <router-link
            ...
            <mail-outlined
              class="app-link-icon"
              style="color: #5cdbd3;"/>
            <div class="app-link-title">消息通知</div>
          </router-link>
        </a-card>
      </a-col>
      <a-col :lg="3" :md="6" :sm="12" :xs="12">
        <a-card
          ...
          <router-link
            ...
            <tags-outlined
              class="app-link-icon"
              style="color: #ff85c0;"/>
            <div class="app-link-title">友链管理</div>
          </router-link>
        </a-card>
      </a-col>
      <a-col :lg="3" :md="6" :sm="12" :xs="12">
...
export default {
  ...
  data() {
    return {
      ...
      activities: [
        {
          title: '古吉拉特 反馈的信息 登录提示操作失败',
          time: '20:30',
          color: 'gray'
        },
        {
          title: '古吉拉特 反馈的信息 按钮颜色与设计不符',
          time: '19:30',
          color: 'gray'
        },
        {
          title: '项目经理 指派了任务 解决项目一解决方案整改',
          time: '18:30'
        },
        {
          title: '项目经理 指派了任务 解决项目二解决方案整改',
          time: '17:30'
        },
        {
          title: '项目经理 指派了任务 解决项目三解决方案整改',
          time: '16:30'
        },
        {
          title: '项目经理 指派了任务 解决项目四解决方案整改',
          time: '15:30',
          color: 'gray'
        },
        {
          title: '项目经理 指派了任务 解决项目五解决方案整改',
          time: '14:30',
          color: 'gray'
        },
        {
          title: '项目经理 指派了任务 解决项目六解决方案整改',
          time: '12:30',
          color: 'gray'
        },
        {
          title: '项目经理 指派了任务 解决项目七解决方案整改',
          time: '11:30'
        },
        {
          title: '项目经理 指派了任务 解决项目八解决方案整改',
          time: '10:30',
          color: 'gray'
        },
        {
          title: '项目经理 指派了任务 解决项目九解决方案整改',
          time: '09:30',
          color: 'green'
        },
        {
          title: '项目经理 指派了任务 解决项目十解决方案整改',
          time: '08:30',
          color: 'red'
        }
      ],
      ...
      taskList: [
        {
          id: 1,
          priority: 1,
          taskName: '解决项目一解决方案整改',
          state: 0
        },
        {
          id: 2,
          priority: 2,
          taskName: '解决项目二解决方案整改',
          state: 0
        },
        {
          id: 3,
          priority: 2,
          taskName: '解决项目三解决方案整改',
          state: 1
        },
        {
          id: 4,
          priority: 3,
          taskName: '解决项目四解决方案整改',
          state: 1
        },
        {
          id: 5,
          priority: 3,
          taskName: '解决项目五解决方案整改',
          state: 2
        },
        {
          id: 6,
          priority: 3,
          taskName: '解决项目六解决方案整改',
          state: 2
        }
      ],
      // 项目进度数据
