    ...
    <a-card :bordered="false">
      ...
      <ele-pro-table
        ...
        <template #platform="{ record }">
          <a-tag
            :color="['green', 'blue', 'red', 'orange'][record.platform-1]">
...
export default {
  ...
  methods: {
    ...
    remove(row) {
      ...
      this.$http.delete('/system/adsort/delete/' + [row.id]).then(res => {
        hide();
        if (res.data.code === 0) {
    ...
    removeBatch() {
      ...
      this.$confirm({
        ...
        onOk: () => {
          const hide = this.$message.loading('请求中..', 0);
          this.$http.delete('/system/adsort/delete', {
