    ...
    <a-form
      ...
      <a-row :gutter="16">
        ...
        <a-col :md="12" :sm="24" :xs="24">
          ...
          <a-form-item label="站点域名" name="isDomain">
            <a-radio-group
              v-model:value="form.isDomain">
  ...
  methods: {
    ...
    save() {
      this.$refs.form.validate().then(() => {
        this.loading = true;
        this.$http[this.isUpdate ? 'put' : 'post'](this.form.id ? '/system/item/edit' : '/system/item/add', this.form).then(res => {
          this.loading = false;
          if (res.data.code === 0) {
